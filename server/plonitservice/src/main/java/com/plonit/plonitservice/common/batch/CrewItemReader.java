...
public class CrewItemReader implements ItemReader<Ranking> {
    ...
    public Ranking read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
        Set<ZSetOperations.TypedTuple<String>> items = redisUtils.getSortedSetRangeWithScores(Rank.CREW.getDescription(), currentIndex, currentIndex);
